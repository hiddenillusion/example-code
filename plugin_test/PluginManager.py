...
class Manager(object):
	...
	def show_cls_details(self, cls_name):
		try:	
			details = cls_name().show_details()	
			print "{0}".format(details.get('name'))
			print "\tCategories: \t{0}".format(details.get('categories'))		
			print "\tArtifact Type: \t{0}".format(details.get('artifact_type'))					
			print "\tAuthor: \t{0}".format(details.get('author'))
			print "\tVersion: \t{0}".format(details.get('version'))
			print "\tDate: \t\t{0}".format(details.get('date'))			
			print "\tDescription: \t{0}".format(details.get('description'))
			print "\tReferences: \t{0}".format(details.get('references'))				
			print "\tRequirements: \t{0}".format(details.get('requirements'))					
			print "\tPrint Fields: \t{0}".format(details.get('fields'))	
			print "\tPlugin Path: \t{0}".format(details.get('path'))
		except AttributeError as err:
			#print "[!] Fix cls: {0}".format(cls_name)	
			#print traceback.format_exc()
			pass			
